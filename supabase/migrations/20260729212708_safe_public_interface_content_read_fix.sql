create or replace view public.published_interface_content_v2 as
select
...
grant select on public.published_interface_content_v2 to anon,authenticated,service_role;
...
as $function$
  ...
  from public.published_interface_content_v2 entry
...
revoke all on public.published_interface_content from anon,authenticated;
drop view if exists public.published_interface_content;
