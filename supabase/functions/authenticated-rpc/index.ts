...
const allowedRpcs = new Set(`archive_admin_interface_content publish_admin_track register_admin_interface_content save_admin_journey save_admin_lesson patch_admin_lesson save_admin_track save_admin_track_v2 archive_admin_track archive_library_content award_participant_action_points complete_participant_activity complete_participant_diagnostic_with_points list_operator_certificate_templates abort_announcement_banner_upload abort_external_credential_upload abort_library_upload abort_practice_upload attach_library_content_to_activity clear_admin_activity_parts confirm_announcement_banner_upload confirm_certificate_template_upload confirm_external_credential_upload confirm_library_upload confirm_practice_upload configure_admin_path_template configure_certificate_version create_activity_comment create_admin_journey_draft_from_version create_announcement_banner_upload_intent create_certificate_template_upload_intent create_external_credential_upload_intent create_library_upload_intent create_practice_upload_intent e14_acknowledge_section e14_complete_diagnostic e14_create_enrollment e14_get_operator_result e14_get_operator_workspace e14_get_participant_experience e14_get_participant_state e14_list_eligible_journeys e14_list_operator_instances e14_list_participant_journeys e14_publish_vertical e14_record_diagnostic_response e14_record_quick_check_answer e14_self_enroll e14_start_activity e14_start_diagnostic e14_start_journey e14_start_quick_check e14_submit_quick_check ensure_participant_default_path ensure_participant_open_paths focus_participant_activity get_activity_asset_download get_activity_utility_rating get_admin_interface_content get_admin_certificate_issuer get_admin_certificate_issuer_media_download get_admin_gamification_workspace get_admin_home_badge_highlights get_admin_lesson_thumbnail_download get_admin_journey_editor_details get_admin_product_workspace get_admin_reporting_dashboard get_announcement_banner_download get_business_maturity_draft get_certificate_render_payload get_external_credential_download get_journey_cover_download get_interface_content_image_download get_library_content get_library_file_download get_optional_diagnostic_responses get_participant_diagnostic_summary get_participant_featured_badges get_participant_lesson_thumbnail_download get_participant_engagement_hub get_participant_experience_with_default_diagnostic get_participant_journey_outline get_participant_profile_summary get_practice_download_descriptor grant_organization_role issue_learning_credentials list_activity_comments list_admin_identity_resolution_cases list_external_credential_issuers list_library_content list_operator_activity_comments list_operator_announcements list_operator_library_content list_operator_practice_submissions list_organization_role_management list_participant_credentials list_participant_external_credentials list_participant_point_rules list_practice_submissions moderate_activity_comment persist_configurable_product_result provision_public_signup_participant_v3 publish_admin_interface_content publish_admin_journey_version publish_certificate_version publish_library_content rate_activity_utility record_activity_asset_progress record_library_content_access resolve_admin_identity_resolution_case resolve_participant_diagnostic_entry retire_admin_diagnostic review_practice_submission revoke_organization_role save_admin_interface_content save_admin_certificate_issuer save_admin_home_badge_highlights save_admin_badge_catalog save_admin_path_badge save_admin_product_resource save_library_content_draft save_operator_announcement set_participant_application_objective update_admin_activity_asset_metadata_by_asset`.split(/\s+/u));

const participantOnlyRpcs = new Set(`award_participant_action_points complete_participant_activity complete_participant_diagnostic_with_points abort_external_credential_upload abort_practice_upload confirm_external_credential_upload confirm_practice_upload create_activity_comment create_external_credential_upload_intent create_practice_upload_intent e14_acknowledge_section e14_complete_diagnostic e14_get_participant_experience e14_get_participant_state e14_list_eligible_journeys e14_list_participant_journeys e14_record_diagnostic_response e14_record_quick_check_answer e14_self_enroll e14_start_activity e14_start_diagnostic e14_start_journey e14_start_quick_check e14_submit_quick_check ensure_participant_default_path ensure_participant_open_paths focus_participant_activity get_activity_asset_download get_activity_utility_rating get_business_maturity_draft get_certificate_render_payload get_external_credential_download get_journey_cover_download get_library_content get_library_file_download get_optional_diagnostic_responses get_participant_diagnostic_summary get_participant_engagement_hub get_participant_experience_with_default_diagnostic get_participant_journey_outline get_participant_profile_summary get_practice_download_descriptor issue_learning_credentials list_activity_comments list_external_credential_issuers list_library_content list_participant_credentials list_participant_external_credentials list_participant_point_rules list_practice_submissions rate_activity_utility record_activity_asset_progress record_library_content_access resolve_participant_diagnostic_entry set_participant_application_objective get_participant_featured_badges get_participant_lesson_thumbnail_download`.split(/\s+/u));
...
async function handleRequest(request: Request): Promise<Response> {
  ...
  if (!supabaseUrl || !anonKey || !serviceRoleKey) {
    return jsonResponse(500, { ok: false, code: "RUNTIME_CONFIGURATION_INVALID", message: "Runtime configuration is unavailable" }, { id, startedAt, operation, metrics });
  }
