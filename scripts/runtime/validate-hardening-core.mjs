...
import { requiredFinalReleaseMigrations } from "../database/migration-history/active-release-boundary.mjs";
...
]) assert.ok(requiredFinalReleaseMigrations.includes(file), `final release migration missing from inventory: ${file}`);
