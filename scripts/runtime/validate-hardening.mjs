...
const [
  ...
  read("supabase/migrations/20260729182300_m17_runtime_hardening.sql"),
  read(".env.example"),
]);
...
process.stdout.write("[runtime-hardening] reproducibility, security, performance and capacity controls are present\n");
