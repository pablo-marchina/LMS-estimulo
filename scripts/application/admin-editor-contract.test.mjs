...
test("interface editor uses the effective permission and does not rely on an authenticated iframe", () => {
  ...
  assert.doesNotMatch(interfaceSelector, /<iframe/u);
  assert.doesNotMatch(interfaceSelector, /postMessage/u);
});
