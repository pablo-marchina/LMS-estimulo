...
function Hero({ outline }: { outline: ParticipantJourneyOutline }) {
  ...
  return (
    <header data-journey-hero className={`relative min-h-[21rem] overflow-hidden rounded-[2rem] p-6 text-white shadow-lg sm:p-9 ${heroToneClasses[tone] ?? heroToneClasses.blue}`}>
      {cover ? (
        <>
