...
export default async function ParticipantHome() {
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-5 py-6 lg:px-9 lg:py-8">
      <header className="brand-welcome-strip"><div><p className="inline-flex items-center gap-2 text-sm font-bold text-primary"><span aria-hidden="true">👋</span> Olá, {firstName}!</p><h1 className="display-font mt-2 text-4xl text-secondary sm:text-5xl">Vamos fazer seu negócio crescer?</h1><p className="mt-3 max-w-3xl text-sm leading-6 text-muted sm:text-base">Escolha um conteúdo, aprenda no seu ritmo e coloque em prática no dia a dia do seu negócio.</p></div><div className="brand-welcome-bubbles" aria-hidden="true"><span /><span /><span /></div></header>

      <div className="mt-8"><AnnouncementCarousel announcements={engagement?.announcements ?? []} /></div>
