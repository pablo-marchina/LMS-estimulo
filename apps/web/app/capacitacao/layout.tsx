...
export default async function CapacityLayout({ children }: { children: React.ReactNode }) {
  ...
  if (auth.status === "anonymous") return <main className="mx-auto max-w-2xl px-4 py-16"><StatusPanel title="Sessão necessária" tone="warning"><p>Entre novamente para acessar a biblioteca.</p></StatusPanel></main>;
