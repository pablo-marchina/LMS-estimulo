                    ...
                    {canManageRoles ? (
                      <Td>
                        <div className="flex flex-wrap justify-end gap-2">
                          ...
                          {usesGoogle ? (
                            <ButtonLink href="/entrar/administracao" variant="secondary" size="sm">Abrir acesso Google</ButtonLink>
                          ) : (
                            <form action={sendUserPasswordRecoveryAction}>
                              <input type="hidden" name="organization_id" value={organization.organization_id} />
                              <input type="hidden" name="email" value={membership.email} />
                              <Button type="submit" variant="secondary" size="sm">Enviar recuperação</Button>
                            </form>
                          )}
                        </div>
                      </Td>
