...
type ParticipantAssessmentQuestion = Omit<AssessmentQuestion, "response"> & {
...
type Props = {
  ...
  questions: ParticipantAssessmentQuestion[];
      ...
      {questions.map((question, index) => {
        ...
        return (
          <Card key={question.id} className="grid gap-3 after:!hidden">
            <fieldset disabled={!contentReady || !attemptAvailable || question.responseRecorded}>
              ...
              {question.responseRecorded ? <p className="mt-3 rounded-xl bg-success-soft p-3 text-sm font-semibold text-success">Resposta registrada nesta tentativa.</p> : open ? (
