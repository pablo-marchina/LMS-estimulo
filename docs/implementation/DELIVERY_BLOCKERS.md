...
| `SECURITY-PRIVACY-REAL-USERS` | P0 | faltam políticas, retenção, direitos, scanner, rate limiting e secret scanning | controles implementados e aprovados |
...
| `LEGACY-REUSE-EVIDENCE` | P2 | falta matriz explícita de reaproveitamento | inventário de manter/substituir/remover |
| `GITHUB-MAINTENANCE-HARDENING` | P1 | faltam lint, secret scanning e proteção/revisão comprovadas | gates e branch protection verificados |
