...
O build standalone e o comportamento 200/503 dos probes foram comprovados antes das últimas mudanças de experiência. A validação precisa ser repetida quando um runner executar steps. A imagem OCI ainda precisa ser construída e escaneada em ambiente com Docker/BuildKit.
...
- buckets S3 privados, versionados, KMS, ACLs e policies públicas bloqueadas e SSE-C bloqueado;
