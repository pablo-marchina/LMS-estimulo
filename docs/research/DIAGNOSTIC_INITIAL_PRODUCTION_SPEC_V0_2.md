# Especificação do diagnóstico da release inicial de produção v0.2
...
O diagnóstico da release inicial de produção terá duas finalidades:
...
```json
{
  "instrument_version": "diagnostic-production-v0.2",
  "status": "completed",
