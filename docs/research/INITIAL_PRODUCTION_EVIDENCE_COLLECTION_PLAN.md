# Plano de coleta de evidências na coorte inicial de produção
...
Transformar o primeira coorte de produção da Jornada OpenAI em uma fonte prospectiva de evidências para:
...
A coorte inicial de produção deverá permitir responder:
