# Estratégia de personalização da release inicial de produção sem entrevistas obrigatórias

**Versão:** 0.2  
**Data:** 2026-07-08  
**Status:** Decisão operacional para a release inicial de produção

## 1. Decisão

A release inicial de produção não dependerá da definição final dos quatro arquétipos.
...
A release inicial de produção usará tags não exclusivas e temporárias, em vez de arquétipos fixos.
...
- resultados do crédito não serão usados na release inicial de produção para recalibrar perfis sem governança específica.
...
## 9. Critério de conclusão do E07 para a release inicial de produção
...
- segmentos operacionais;
- plano de coleta da coorte inicial de produção;
- plano de descoberta futura dos arquétipos;
- política de incerteza e equidade.

A validação empírica dos quatro arquétipos passa a ser uma etapa posterior, não um bloqueio da release inicial de produção.
