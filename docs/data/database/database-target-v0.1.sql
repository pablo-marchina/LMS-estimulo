-- Plataforma Estímulo — modelo físico preliminar v0.1
-- PostgreSQL-compatible. Provider/auth adapter will be selected in E12.
-- This file is a design baseline, not yet an approved production migration.
...
create table iam.user_accounts (
  ...
  constraint uq_iam_user_accounts_auth_provider_auth_subject unique (auth_provider, auth_subject),
